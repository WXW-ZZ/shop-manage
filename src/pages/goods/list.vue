        ...
        <el-card shadow="never" class="border-0">
            ...
            <ListHeader layout="create,refresh" @create="handleCreate" @refresh="getData">
                <el-button size="small" @click="handleMultiDelete"
                    v-if="searchForm.tab!='delete'" type="danger">
                    批量删除
                </el-button>
                <el-button size="small" @click="handleRestoreGoods"
                    v-else type="warning">
                    恢复商品
                </el-button>
                <el-popconfirm v-if="searchForm.tab=='delete'" title="是否要彻底删除该商品?" confirm-button-text="确认" cancel-button-text="取消" @confirm="handleDestortGoods">
                     <template #reference>
            ...
            <el-table ref=" multipleTableRef" @selection-change="handleSelectionChange" :data="tableData" stripe
                    ...
                    <template #default="{ row }">
                        <div class="flex">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-grey-400 text-xs mb-1">分类：{{ row.category?row.category.name:'未分类' }}
                                </p>
                                <p class="text-grey-400 text-xs ">创建时间:{{ row.create_time }}</p>
                            </div>
                ...
                <el-table-column label="审核状态" width="120" align="center">
                    <template #default="{ row }">
                        <div class="felx flex-col" v-if="row.ischeck==0">
                ...
                <el-table-column label="操作" align="center">
                    <template #default="scope">
                        <div v-if="searchForm.tab!='delete'">
                            ...
                            (scope.row.stu_type==1&&!scope.row.goods_skus.length)?'danger':'primary'"size="small" text @click="handleSetGoodsSkus(scope.row)" :loading="scope.row.skusLoading">
                                商品规格
                            </el-button>
