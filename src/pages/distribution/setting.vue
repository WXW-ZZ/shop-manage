            ...
            <h5 class="bg-gray-100 p-3 rounded mb-5">返佣设置</h5>
                     <el-form-item label="一级返佣比例" >
                      <div>
                       ...
                       <small class="text-gray-100 flex mt-1">请补全http://或https://-一级返佣比例</small>                 
                      </div>
                    </el-form-item>
                    <el-form-item label="二级返佣比例" >
                      <div>
                       ...
                       <small class="text-gray-100 flex mt-1">请补全http://或https://-二级返佣比例</small>                 
                      </div>
                    </el-form-item>
                    <el-form-item label="自购返佣" >
                            ...
                            <small class="text-gray-500 flex mt-1">请补全http://或https://-二级返佣比例</small> 
                            </div>
                    </el-form-item>
            <h5 class="bg-gray-100 p-3 rounded mb-5">结算设置</h5>
                <el-form-item label="结算时间" >
                        <div>
                            <el-input v-model="form.store_first_rebate" placeholder="结算时间" style="width: 80%;" type="number">
                            <template #prepend>订单完成</template>
                            <template #append>天</template>
                        </el-input>                
                        <small class="text-gray-500 flex mt-1">请补全http://或https://-一级返佣比例</small>                 
                        </div>
