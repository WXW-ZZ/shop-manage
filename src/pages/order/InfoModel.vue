<template>
    <el-drawer title="订单详情" v-model="dialogVisable" size="50%">
        ...
        <el-card shadow="never" class="mb-3" v-if="info.ship_data" >
            ...
            <el-form label-width="80px">
                ...
                <el-form-item label="运单号">
                    ...
                    <el-button type="primary" text size="small" class="ml-3" :loadind="loading" @click="openShipInfoModel(info.id)">
                        查看物流
                    </el-button>
                </el-form-item>
        ...
        <el-card shadow="never" class="mb-3">
            ...
            <el-form label-width="80px" v-if="info.address">
...
const openShipInfoModel=(id)=>{
    loading.value=true
    ShipInfoModelRef.value.open(id).finally(()=>loading.value=false)
}
